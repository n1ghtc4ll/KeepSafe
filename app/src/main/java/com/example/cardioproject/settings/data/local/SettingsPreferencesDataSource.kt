...
class SettingsPreferencesDataSource(
    ...
    suspend fun updateDeviceInfo(name: String, batteryLevel: Int, isConnected: Boolean) {
    ...
    private companion object {
        ...
        val DEFAULT_ZONES = listOf(
            HeartRateZoneDto(index = 0, label = "Зона 1", lowerBpm = 60, upperBpm = 79),
            HeartRateZoneDto(index = 1, label = "Зона 2", lowerBpm = 60, upperBpm = 79),
            HeartRateZoneDto(index = 2, label = "Зона 3", lowerBpm = 60, upperBpm = 79),
            HeartRateZoneDto(index = 3, label = "Зона 4", lowerBpm = 60, upperBpm = 79)
        )
    }
}